...
function comercio_canjeo_ofertas_shortcode() {
    ?>
    ...
    <script>
        jQuery(document).ready(function () {
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            jQuery.ajax({
                                ...
                                url: ajaxurl,
                                data: {
                                    action: "buscar_ofertas", // Acción que indica qué función de PHP llamar
                                    user_id: user_id
                                },
                                success: function (response) {
                                    if (response.success) {
            ...
            jQuery('#ofertas-form').submit(function (event) {
                ...
                jQuery('#ofertas-form input[type="checkbox"][name="ofertas_canjeado[]"]:checked').each(function () {
...
add_shortcode('comercio_canjeo_ofertas', 'comercio_canjeo_ofertas_shortcode');